...
public class Main {
    ...
    public static void writeArrayToFile(int[] arr, String fileName) {
        try (BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("src/Task1/" + fileName))) {
    ...
    public static int[] readArrayFromFile(String fileName) {
        try {
            BufferedReader bufferedReader = new BufferedReader(new FileReader("src/Task1/" + fileName));
